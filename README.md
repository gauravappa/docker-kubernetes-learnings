...
| Container lifecycle | [docker/fundamentals/container-lifecycle](docker/fundamentals/container-lifecycle) | create/start/run, running vs stopped, stop vs kill, rm |
